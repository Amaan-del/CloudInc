...
export const CustomRoomTable = () => {
  ...
  return availableRooms.length === 0 ? (
    <MessageText>There are no any custom office now, create one or join the common office.</MessageText>
  ) : (
    <>
      ...
      <PasswordDialog open={showPasswordDialog} onClose={resetPasswordDialog}>
        <form onSubmit={handlePasswordSubmit}>
          <DialogContent className="dialog-content">
            <MessageText>This a private office room, please enter password:</MessageText>
            <TextField
              autoFocus
              fullWidth
