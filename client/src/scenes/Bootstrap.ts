...
export default class Bootstrap extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('backdrop_day', 'assets/background/black.png')
    this.load.atlas(
      'cloud_night',
      'assets/background/black.png',
      'assets/background/cloud_night.json'
    )
    this.load.image('backdrop_night', 'assets/background/black.png')
    this.load.image('sun_moon', 'assets/background/black.png')
